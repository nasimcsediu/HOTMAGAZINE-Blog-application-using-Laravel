                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        ...
                        <div class="widget-body">
                            <!-- BEGIN FORM-->
                          <form action="{{URL::to('update-catagory/'.$catagory_manage_info->catagory_id)}}" method="post">
                            {{ csrf_field() }}
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <textarea class="span6"  id="richTextBody" name="catagory_description" rows="3">{{($catagory_manage_info->catagory_description)}}</textarea>
                                </div>
                            </div>
                             ...
                             <div class="control-group">
                                ...
                                <div class="controls">
                                    <select class="span6 " name="catagory_status" data-placeholder="Choose a Category" tabindex="1">
